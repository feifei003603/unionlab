...
<div class="line1">
	...
	<div id="col_3">
			...
			<div id="jhc">
        		<div >
          			<ul class="con_con">
					<{ section name=rec loop=$recommends max=6 }>
						<li><a href="<{$app}>/article/index/aid/<{ $recommends[rec].id }>"><{ $recommends[rec].title|truncate:14}></a> <span style="font-size:10px">(<span class="redh"><{$recommends[rec].recommend}></span>人推荐)</span></li>
					<{ sectionelse }>
						<li>目前没有任何推荐文章</li>
					<{ /section }>
          			</ul>
        		 ...
        		 <div  style="display:none">
          			<ul class="con_con">
					<{ section name=hot loop=$hots max=6 }>
						<li><a href="<{$app}>/article/index/aid/<{ $hots[hot].id }>"><{ $hots[hot].title|truncate:13}></a><span style="font-size:10px">(浏览<span class="redh"><{$hots[hot].views}></span>次)</span></li>
					<{ sectionelse }>
						<li>目前没有任何热门文章</li>
					<{ /section }>
          			</ul>
			...
			<div  style="display:none">
            			<ul class="con_con">
					<{ section name=new loop=$news max=6 }>
		...
		<{ section name=col loop=$cols }>
			...
			<div class="<{if $smarty.section.col.index mod 3 eq 0}>mbox1<{elseif $smarty.section.col.index mod 3 eq 1}>mbox2<{else}>mbox3<{/if}>">
					...
					<div class="box_bg w263">
						<ul class="con_con">
							<{ section name=article loop=$cols[col].art max=6 }>
								<li><a href="<{$app}>/article/index/aid/<{ $cols[col].art[article].id }>"><{ $cols[col].art[article].title|truncate:18}></a></li>
							<{ sectionelse }>
