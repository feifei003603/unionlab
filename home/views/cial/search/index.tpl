		...
		<div class="sidebox">
        		...
        		<div class="dd dot">
					...
					<{ section name=article loop=$recommends max=10 }>
						<li><a href="<{$app}>/article/index/aid/<{ $recommends[article].id }>"><{ $recommends[article].title|truncate:19 }></a></li>
					<{ sectionelse }>
						<li>目前没有任何推荐文章</li>
					<{ /section }>
          			</ul>
		...
		<div class="sidebox">
        		 ...
        		 <div class="dd dot">
					...
					<{ section name=article loop=$news max=10 }>
						<li><a href="<{$app}>/article/index/aid/<{ $news[article].id }>"><{ $news[article].title|truncate:19 }></a></li>
					<{ sectionelse }>
						<li>目前没有任何推荐文章</li>
					<{ /section }>
          			</ul>
		...
		<div class="sidebox">
        		 ...
        		 <div class="dd dot">
					...
					<{ section name=article loop=$hots max=10 }>
						<li><a href="<{$app}>/article/index/aid/<{ $hots[article].id }>"><{ $hots[article].title|truncate:19 }></a></li>
					<{ sectionelse }>
						<li>目前没有任何推荐文章</li>
					<{ /section }>
          			</ul>
