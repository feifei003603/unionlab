<?php /* Smarty version Smarty-3.1.8, created on 2013-07-26 15:16:42
...
"><?php echo smarty_modifier_truncate($_smarty_tpl->tpl_vars['recommends']->value[$_smarty_tpl->getVariable('smarty')->value['section']['article']['index']]['title'],19);?>
</a></li>
					<?php endfor; else: ?>
						<li>目前没有任何推荐文章</li>
					<?php endif; ?>
...
"><?php echo smarty_modifier_truncate($_smarty_tpl->tpl_vars['news']->value[$_smarty_tpl->getVariable('smarty')->value['section']['article']['index']]['title'],19);?>
</a></li>
					<?php endfor; else: ?>
						<li>目前没有任何推荐文章</li>
					<?php endif; ?>
...
"><?php echo smarty_modifier_truncate($_smarty_tpl->tpl_vars['hots']->value[$_smarty_tpl->getVariable('smarty')->value['section']['article']['index']]['title'],19);?>
</a></li>
					<?php endfor; else: ?>
						<li>目前没有任何推荐文章</li>
					<?php endif; ?>
