<?php /* Smarty version Smarty-3.1.8, created on 2013-08-30 16:54:54
         compiled from "./home/views/cial\index\index.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2012552205dded61fd5-79000764%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '52bb291b5f207345a979bd90b03bb015401be084' => 
    array (
      0 => './home/views/cial\\index\\index.tpl',
      1 => 1377828260,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2012552205dded61fd5-79000764',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52205ddf0e4341_41822894',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52205ddf0e4341_41822894')) {function content_52205ddf0e4341_41822894($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include 'E:\\xampp\\htdocs\\unionlab\\brophp\\libs\\plugins\\modifier.truncate.php';
?><?php echo $_smarty_tpl->getSubTemplate ("public/header.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>

<div class="line1">
	<div id="col_1">	
		       
        		<div class="box_bg1 w2631">
        		<h3>网站公告</h3>
          			<ul class="con_con1">
...
$_smarty_tpl->tpl_vars['smarty']->value['section']["nls"]['max'] = (int)10;
$_smarty_tpl->tpl_vars['smarty']->value['section']["nls"]['show'] = true;
if ($_smarty_tpl->tpl_vars['smarty']->value['section']["nls"]['max'] < 0)
...
if ($_smarty_tpl->tpl_vars['smarty']->value['section']["nls"]['show']) {
    $_smarty_tpl->tpl_vars['smarty']->value['section']["nls"]['total'] = min(ceil(($_smarty_tpl->tpl_vars['smarty']->value['section']["nls"]['step'] > 0 ? $_smarty_tpl->tpl_vars['smarty']->value['section']["nls"]['loop'] - $_smarty_tpl->tpl_vars['smarty']->value['section']["nls"]['start'] : $_smarty_tpl->tpl_vars['smarty']->value['section']["nls"]['start']+1)/abs($_smarty_tpl->tpl_vars['smarty']->value['section']["nls"]['step'])), $_smarty_tpl->tpl_vars['smarty']->value['section']["nls"]['max']);
...
/js/player.js"></script>
	...
	<div id="col_3">
    			<div id="jh" class="dt"><strong><div class="box_bg w263"><h3 class="cview" onmouseover="show(0)">强烈推荐</h3> <h3 onmouseover="show(1)">本月热点</h3> <h3 onmouseover="show(2)">最近更新</h3></div></strong></div>
			<div id="jhc">
        		<div >
          			<ul class="con_con">
...
$_smarty_tpl->tpl_vars['smarty']->value['section']['rec']['max'] = (int)6;
...
"><?php echo smarty_modifier_truncate($_smarty_tpl->tpl_vars['recommends']->value[$_smarty_tpl->getVariable('smarty')->value['section']['rec']['index']]['title'],14);?>
...
$_smarty_tpl->tpl_vars['smarty']->value['section']['hot']['max'] = (int)6;
...
"><?php echo smarty_modifier_truncate($_smarty_tpl->tpl_vars['hots']->value[$_smarty_tpl->getVariable('smarty')->value['section']['hot']['index']]['title'],13);?>
...
$_smarty_tpl->tpl_vars['smarty']->value['section']['new']['max'] = (int)6;
...
"><?php echo smarty_modifier_truncate($_smarty_tpl->tpl_vars['news']->value[$_smarty_tpl->getVariable('smarty')->value['section']['new']['index']]['title'],17);?>
</a></li>
					<?php endfor; else: ?>
						<li>目前没有任何文章更新</li>
					<?php endif; ?>
...
?>
			...
			<div class="<?php if ($_smarty_tpl->getVariable('smarty')->value['section']['col']['index']%3==0){?>mbox1<?php }elseif($_smarty_tpl->getVariable('smarty')->value['section']['col']['index']%3==1){?>mbox2<?php }else{ ?>mbox3<?php }?>">
...
">更多...</a></span></div>
        			<div class="dd">
					<?php if ($_smarty_tpl->getVariable('smarty')->value['section']['col']['index']%3==1){?>
					<div class="left">
						<a href="<?php echo $_smarty_tpl->tpl_vars['app']->value;?>
/list/index/pid/<?php echo $_smarty_tpl->tpl_vars['cols']->value[$_smarty_tpl->getVariable('smarty')->value['section']['col']['index']]['id'];?>
...
$_smarty_tpl->tpl_vars['smarty']->value['section']['article']['max'] = (int)6;
...
"><?php echo smarty_modifier_truncate($_smarty_tpl->tpl_vars['cols']->value[$_smarty_tpl->getVariable('smarty')->value['section']['col']['index']]['art'][$_smarty_tpl->getVariable('smarty')->value['section']['article']['index']]['title'],18);?>
</a></li>
							<?php endfor; else: ?>
								<li><a href="">该栏目中没有任何文章</a></li>
							<?php endif; ?>
						</ul>
					</div>
	...
	<div class="nav"> </div>
	<div id="link">
       		<div class="dt"><strong>友情链接</strong></div>
        	<div class="dd">
               		<ul>
