			...
			<div class="msg-box">
				<ul class="viewmess">
					...
					<li class="dark-row">
						...
						<textarea class="text-box" name="proSum" cols="40" rows="4"><{ $post.summary }></textarea>&nbsp;&nbsp;小于400个汉字.
					</li>
					...
					<li class="light-row">
						...
						<input type="text" class="text-box" name="proLabel" size="25" value="<{ $post.comefrom }>" maxlength="25">
					</li>
					<li class="light-row">
						<span class="col_width">项目关键字&nbsp;&nbsp;&nbsp;<span class="red_font">*</span></span>
						<input type="text" class="text-box" name="proKeyword" size="25" value="<{ $post.keyword }>" maxlength="20">&nbsp;&nbsp;用于项目搜索,多个请用逗号","隔开.
					</li>
		<li class="dark-row">
